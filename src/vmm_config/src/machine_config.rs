...
// use vmm::cpu_config::templates::{CpuTemplateType, CustomCpuTemplate, StaticCpuTemplate}; // Will use local stubs

// --- Start of local stubs for vmm::cpu_config::templates types ---

/// Placeholder for `vmm::cpu_config::templates::StaticCpuTemplate`
...
pub enum StaticCpuTemplate {
    ...
    /// Placeholder for T2
    T2,
    /// Placeholder for T2CL
    T2CL,
    /// Placeholder for T2S
    T2S,
    /// Placeholder for V1N1 (aarch64)
    V1N1,
    /// No CPU template is applied.
    None,
}

impl Default for StaticCpuTemplate {
    fn default() -> Self {
        StaticCpuTemplate::None
    }
}

/// Placeholder for `vmm::cpu_config::templates::CustomCpuTemplate`
#[derive(Clone, Debug, Default, PartialEq, Eq, Deserialize, Serialize)]
pub struct CustomCpuTemplate {
    // Add fields if necessary for compilation, e.g., based on MachineConfig::set_custom_cpu_template
    // For now, keeping it empty.
}

/// Placeholder for `vmm::cpu_config::templates::CpuTemplateType`
...
#[cfg(test)]
mod tests {
    use vmm::cpu_config::templates::{CpuTemplateType, CustomCpuTemplate, StaticCpuTemplate};
    // Assuming MachineConfig is now part of the current crate (vmm_config)
