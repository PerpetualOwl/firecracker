...
use crate::devices::virtio::pmem::device::VirtioPmem; // Assuming this path after refactor
...
impl PmemBuilder {
    ...
    pub fn insert(&mut self, config: PmemDeviceConfig) -> Result<(), PmemConfigError> {
        ...
        config.validate().map_err(|s| PmemConfigError::InvalidDriveId)?; // Simplified error mapping
